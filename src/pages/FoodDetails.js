                        ...
                        <Col lg="12">
                            ...
                            </div>
                            {
                                tab === 'desc' ? (<div className="tab__content">
                                    <p>{desc}</p>
                                </div>) : (<div className="tab__form mt-3">
                                    <div className="review">
                                        <p className="user__name mb-0">
                                            John Deo
                                        </p>
                                        <p className="user__email  mb-1">
                                            john@gmail.com
                                        </p>
                                    ...
                                    <form className="form" onSubmit={submitHandler}>
                                        ...
                                        <div className="form__group">
                                            <input type="text" placeholder="enter your email" onChange={e => setEnteredemail(e.target.vale)} />
                                        </div>
                                        <div className="form__group">
                                            <textarea rows={5} type="text" placeholder="write your rebew" onChange={e => setEnteredreview(e.target.value)} />
                                        </div>
